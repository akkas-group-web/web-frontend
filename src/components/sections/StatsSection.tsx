    ...
    <section className="relative overflow-hidden py-20">
      ...
      <div className="relative mx-auto grid max-w-7xl items-start gap-14 px-8 md:grid-cols-[1.15fr_0.85fr] md:px-12">
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-2xl font-bold text-brand-navy md:text-3xl">
          ...
          <div className="relative mt-12 flex items-end gap-4">
            {primaryStat && (
              <motion.div
                ...
                className="group relative w-[35%] overflow-hidden rounded-3xl bg-white p-10 shadow-[0_20px_60px_rgba(13,77,92,0.15)] ring-1 ring-brand-navy/5 transition-shadow duration-500 hover:shadow-[0_25px_70px_rgba(13,77,92,0.22)]"
              >
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#333333]/50">
                  <div className="absolute -right-10 -top-10 h-28 w-28 rounded-full bg-brand-teal/10 blur-2xl transition-transform duration-700 group-hover:scale-150" />
                  {primaryStat.sub ?? "Öne Çıkan"}
                </span>
                <div className="font-heading mt-1 text-4xl font-bold text-brand-teal">
            ...
            {restStats.length > 0 && (
              <motion.div
                ...
                className="group relative z-40 -mt-66 w-[54%] translate-x-12 overflow-hidden rounded-3xl bg-gradient-to-br from-brand-teal to-brand-teal-dark p-6 text-white shadow-[0_25px_60px_rgba(17,139,153,0.25)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_30px_75px_rgba(17,139,153,0.32)] md:translate-x-1 md:-mr-20"
              >
        ...
        >
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2.5rem] shadow-2xl shadow-brand-teal/15"
          >
            <Image
              src={imageSrc}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-brand-navy/50 via-brand-teal/0 to-transparent" />

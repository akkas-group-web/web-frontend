...
export default function ChatWidget() {
  ...
  ============================================================
  SOHBET GEÇMİŞİ
  Geçmiş özelliği şimdilik devre dışı bırakıldı.
  ============================================================
    ...
    try {
      ...
      setHistory(
        historyList.map((h) => ({
          ...
          title:
            h.preview?.slice(0, 40) ||
            "Sohbet",

          preview:
            h.preview?.slice(0, 60) ||
            "",
  ...
  async function sendToBackend(
    ...
    try {
      ...
      if (res.ok) {
        ...
        /*
        Sohbet geçmişi kapatıldığı için
        geçmiş listesini tekrar çekmiyoruz.
